...
fn main() {
    ...
    for item in &memory_stats.cells[0..10] {
        println!("{}", item);
    }
    ...
    println!("NAME: {} | STATS: {} | PRIM: {:#x} | BLOCK_END: {:#x}",init_code_block.0, init_code_block.1, init_code_block.2, init_code_block.3);
    println!("NAME: {} | STATS: {} | PRIM: {:#x} | BLOCK_END: {:#x}",init_stack_block.0, init_stack_block.1, init_stack_block.2, init_stack_block.3);
    println!("NAME: {} | STATS: {} | PRIM: {:#x} | BLOCK_END: {:#x}",init_data_block.0, init_data_block.1, init_data_block.2, init_data_block.3);
    println!("NAME: {} | STATS: {} | PRIM: {:#x} | BLOCK_END: {:#x}",init_extra_block.0, init_extra_block.1, init_extra_block.2, init_extra_block.3);
