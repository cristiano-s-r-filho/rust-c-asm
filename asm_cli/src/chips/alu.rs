...
impl ALU {
    ...
    pub fn execute_instruction(&mut self,working_env: (WorkMemory,MainRegisters,OffsetRegisters,SegmentRegisters,EFLAG), pro_mmu: MMU ,instruction: &str, operand1:u32 , operand2:u32) {
        match instruction {
